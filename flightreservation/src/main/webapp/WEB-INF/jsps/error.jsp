...
<body>
	...
	<div class="container">
		<div class="main">
			...
			<div class="title">
				<h1 class="text-center">Welcome To Spring Boot Flight
					Reservation App</h1>
			</div>
			<h1>Not Allowed!!!!!</h1>
			<div class="d-flex justify-content-center hero">
				<div class="col-md-4 text-center">
					<span class="mainsub">New Users click here to register</span> <a
						class="text-center" href="showReg"><span class="btn btn-info">Register</span></a>
				</div>
				<div class="col-md-4 text-center">
					<span class="mainsub">Existing Users click here to login</span> <a
						class="text-center" href="showLogin"><span
